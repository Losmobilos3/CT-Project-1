...
if("TRUE" STREQUAL "TRUE")
  set(hls_lfcd_lds_driver_SOURCE_PREFIX /home/ubuntu/catkin_ws2/src/hls_lfcd_lds_driver)
  set(hls_lfcd_lds_driver_DEVEL_PREFIX /home/ubuntu/catkin_ws2/devel)
  ...
  set(hls_lfcd_lds_driver_INSTALL_PREFIX /home/ubuntu/catkin_ws2/install)
...
if(NOT "/home/ubuntu/catkin_ws2/src/hls_lfcd_lds_driver/include;/usr/include " STREQUAL " ")
  set(hls_lfcd_lds_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws2/src/hls_lfcd_lds_driver/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hls_lfcd_lds_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws2/src/hls_lfcd_lds_driver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/catkin_ws2/devel/lib;/home/ubuntu/catkin_ws2/devel/lib;/home/ubuntu/catkin_ws/devel/lib;/opt/ros/melodic/lib)
